...
export function storeItemsTryUpdate(
...
export function storeItemsTryDelete(
  items: Array<unknown> | null,
  idValue: unknown,
  idField = "id"
): boolean {
...
export function storeItemsConcat<T>(
  items: Array<T> | null,
  results: Array<T>
): Array<T> {
...
export function promiseSetLoading(
  prom: Promise<unknown>,
  loadingVar: Ref<boolean>
) {
